...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    // sandeep add new airport fbo details routes
    Route::post('customer/airport-fbo', [AddressController::class, 'store_airport_fbo']);
    ...
    // sandeep add route for get order timeline
    Route::get('customer/orders-timeline/{id}', [OrderController::class, 'getTimeline']);
    ...
    // sandeep add route for update cart item qty
    Route::put('customer/cart/update-qty/{itemid}', [CartController::class, 'update_item_qty']);
