...

{
    ...
    public function update(CustomerAddressRequest $request, int $id)
    {
        ...
        // sandeep comment code new airport fbo details add code
        // if (!array_key_exists('airport_fbo_id', $data) || empty($data['airport_fbo_id'])) {
        //     $validation = Validator::make($request->all(),[
        //         'airport_fbo_name' => 'required',
        //         'airport_fbo_address' => 'required',
        ...
        if($request->delivery_date || $request->delivery_time){
            ...
            // sandeep update deafault address
            DB::table('addresses')
            ->where('customer_id', $customerId)
    ...
    // sandeep add function add new airport fbo
    public function store_airport_fbo(Request $request){
        ...
        // update airport_fbo_id in address table
