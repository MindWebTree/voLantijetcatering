...
class OrderResource extends JsonResource
{
    ...
    {
        // sandeep || add order notes and fbo details
        return [
            'id'                                  => $this->id,
            ...
            'fbo_full_name'                       => $this->fbo_full_name,
            'fbo_phone_number'                    => $this->fbo_phone_number,
            'fbo_email_address'                   => $this->fbo_email_address,
            'fbo_tail_number'                     => $this->fbo_tail_number,
            'fbo_packaging'                       => $this->fbo_packaging,
            'fbo_service_packaging'               => $this->fbo_service_packaging,
